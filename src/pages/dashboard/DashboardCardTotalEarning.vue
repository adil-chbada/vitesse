...
export default {
  setup() {
    const totalEarning = [
      {
        avatar: requireAssets('assets/images/logos/zipcar.png'),
        title: 'Zipcar',
      ...
      {
        avatar: requireAssets('assets/images/logos/bitbank.png'),
        title: 'Bitbank',
      ...
      {
        avatar: requireAssets('@/assets/images/logos/aviato.png'),
        title: 'Aviato',
