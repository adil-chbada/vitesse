<script>
import { mdiAccountOutline, mdiInformationOutline, mdiLockOpenOutline } from '@mdi/js'
...
export default {
  ...
  setup() {
    ...
    const accountSettingData = {
      account: {
        avatarImg: requireAssets('assets/images/avatars/1.png'),
        username: 'johnDoe',
        name: 'john Doe',
...
<template>
  <v-card id="account-setting-card">
    ...
    <v-tabs-items v-model="tab">
      <v-tab-item>
        <AccountSettingsAccount :account-data="accountSettingData.account" />
      </v-tab-item>
      ...
      <v-tab-item>
        <AccountSettingsInfo :information-data="accountSettingData.information" />
      </v-tab-item>
    </v-tabs-items>
  </v-card>
</template>
